let kinningParkHouse = {
  ...
  */
  ...
  function getEmailAddresses(house1, house2) {
    //let emailAddresses = house1.currentOwner.email.concat(", ", house2.currentOwner.email);
  ...
  function getCheapestAddress(house1, house2) {
    if (house1.price > house2.price){
      return house1.address + " cheaper than "+ house2.address
    }else {
      return house2.address + " cheaper than "+ house1.address
    }
  }
